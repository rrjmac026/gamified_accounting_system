    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-[#FFF0FA] dark:from-[#4B4B4B] dark:to-[#3B3B3B] 
                ...
                <h2 class="text-2xl font-bold text-[#FF92C2] dark:text-[#FF92C2] mb-6">Edit Instructor</h2>

                <form action="{{ route('admin.instructors.update', $instructor) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
