                ...
                <form action="{{ route('admin.student.update', $student) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="first_name" value="{{ old('first_name', $student->user->first_name) }}"
                                class="w-full rounded-lg border border-[#FFC8FB] focus:border-pink-400 focus:ring focus:ring-pink-200 
                                       text-gray-800 px-4 py-2 shadow-sm transition-all duration-200
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="email" name="email" value="{{ old('email', $student->user->email) }}"
                                class="w-full rounded-lg border border-[#FFC8FB] focus:border-pink-400 focus:ring focus:ring-pink-200 
                                       text-gray-800 px-4 py-2 shadow-sm transition-all duration-200" required>
                        ...
                        {{-- Student Number --}}
                        <div>
                            <label class="block text-sm font-semibold text-[#FF92C2] mb-1">Student Number</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="year_level" class="w-full rounded-lg border border-[#FFC8FB] focus:border-pink-400 focus:ring focus:ring-pink-200 
                                                            text-gray-800 px-4 py-2 shadow-sm transition-all duration-200">
                                @for ($i = 1; $i <= 4; $i++)
                        ...
                        {{-- Section as dropdown (instead of radios) --}}
                        <div>
                            <label class="block text-sm font-semibold text-[#FF92C2] mb-1">Section</label>
                            <select name="section_id" class="w-full rounded-lg border border-[#FFC8FB] focus:border-pink-400 focus:ring focus:ring-pink-200 
                                                             text-gray-800 px-4 py-2 shadow-sm transition-all duration-200">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-48 overflow-y-auto border border-[#FFC8FB] rounded-lg p-3 bg-white shadow-sm">
