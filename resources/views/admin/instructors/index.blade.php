...
<x-app-layout>
    ...
    <div class="flex justify-end px-4 sm:px-8 mt-4">
            <a href="{{ route('admin.instructors.create') }}" class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-[#FF92C2] hover:bg-[#ff6fb5] rounded-lg shadow-sm hover:shadow transition-all duration-200">
                        ...
                        <table class="min-w-full table-auto">
                            <thead class="bg-[#FFC8FB]">
                                <tr class="text-xs sm:text-sm">
                                    ...
                                    <th class="py-2 sm:py-3 px-3 sm:px-6 text-left text-sm font-medium text-pink-900">Specialization</th>
                                    <th class="py-2 sm:py-3 px-3 sm:px-6 text-left text-sm font-medium text-pink-900">Subjects</th>
                                    <th class="py-2 sm:py-3 px-3 sm:px-6 text-left text-sm font-medium text-pink-900">Tasks</th>
                                    <th class="py-2 sm:py-3 px-3 sm:px-6 text-left text-sm font-medium text-pink-900">Students</th>
                                    <th class="py-2 sm:py-3 px-3 sm:px-6 text-left text-sm font-medium text-pink-900">Actions</th>
                                </tr>
                            </thead>
                            <tbody class="bg-[#FFF6FD] divide-y divide-[#FFC8FB]">
                                @forelse ($instructors as $instructor)
                                    <tr class="hover:bg-[#FFD9FF] transition-colors duration-150 text-xs sm:text-sm">
                                        <td class="py-4 px-3 sm:px-6 text-sm text-gray-700 dark:text-black-200">
                                            {{ $instructor->name }}
                                        </td>
                                        <td class="hidden sm:table-cell py-4 px-3 sm:px-6 text-sm text-gray-700 dark:text-black-200">
                                            {{ $instructor->email }}
                                        </td>
                                        <td class="hidden md:table-cell py-4 px-3 sm:px-6 text-sm text-gray-700 dark:text-black-200">
                                            {{ $instructor->employee_id ?? 'N/A' }}
                                        </td>
                                        <td class="hidden lg:table-cell py-4 px-3 sm:px-6 text-sm text-gray-700 dark:text-black-200">
                                        ...
                                        <td class="py-4 px-3 sm:px-6 text-sm text-gray-700 dark:text-black-200 space-x-2">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="py-4 px-3 sm:px-6 text-sm text-center text-gray-600">
