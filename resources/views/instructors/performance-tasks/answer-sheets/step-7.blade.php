<x-app-layout>
    ...
    <div class="py-6">
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-bold mt-2">Income Statement</h1>
            <p class="text-gray-600 mt-2">
                Prepare the income statement to show revenues, expenses, and net income or loss for the period.
            </p>
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <form id="saveForm" method="POST" action="{{ route('students.performance-tasks.save-step', 7) }}" class="mt-6 text-right">
                @csrf
