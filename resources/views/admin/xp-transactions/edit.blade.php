            ...
            <div class="bg-[#FFF0FA] dark:from-[#4B4B4B] dark:to-[#3B3B3B] 
                ...
                <form action="{{ route('admin.xp-transactions.update', $xpTransaction) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" required class="w-full rounded-lg bg-white dark:bg-[#595758] border-[#FFC8FB] focus:border-pink-400 focus:ring focus:ring-pink-200" rows="3">{{ $xpTransaction->description }}</textarea>
                    </div>
