            ...
            <div class="bg-white p-6 rounded-lg shadow">
                ...
                <form action="{{ route('instructors.performance-tasks.store') }}" method="POST" id="taskForm" enctype="multipart/form-data">
                    ...
                    <div class="flex items-center justify-end mt-6">
                        ...
                        <button type="submit" 
                                class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            Create Performance Task
                        </button>
                    </div>
